        ...
        <nav className='flex items-center justify-around border-t-[1px] border-zinc-700 bg-zinc-800 py-2'>
            <Link href='/'>
                <button className='flex flex-col items-center'>
                    <Icon theme='home' className={`text-3xl ${activeScreen ? 'text-gray-500' : ''}`} />
            ...
            <Link href='/search'>
                <button className='flex flex-col items-center'>
                    <Icon theme='search' className={`text-3xl ${activeScreen !== 'search' ? 'text-gray-500' : ''}`} />
                    <Typography
                        title='Search'
            ...
            <Link href='/library'>
                <button className='flex flex-col items-center'>
                    <Icon theme='library' className={`text-3xl ${activeScreen !== 'library' ? 'text-gray-500' : ''}`} />
                    <Typography
                        title='Library'
